---
title: "H3K4me3_aging_csaw_pseudoreplicates"
...
anno <- detailRanges(tabbroad$region, txdb=TxDb.Mmusculus.UCSC.mm10.knownGene, orgdb=org.Mm.eg.db, promoter=c(3000,1000), dist=5000)
head(anno$overlap)


Save outputs
```{r}
save.image(file = "K4me3_12m_csaw_pseudo_environment_21062018.Rda")

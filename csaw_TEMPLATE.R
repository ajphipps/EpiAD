---
title: "H3K4me3_AD_12m_pairwise_analysis_csaw"
...
K4me3_bam.files <- file.path("/NGS_Data/Andrew/Pseudoreplicate_BAM/H3K4me3_pseudoreplicate_bam", c("H3K4me3_WT12_pseudo1.sorted.bam", "H3K4me3_WT12_pseudo2.sorted.bam", "H3K4me3_TG12_pseudo1.sorted.bam", "H3K4me3_TG12_pseudo2.sorted.bam"))
```
...
export.bed(test, "H3K4me3_AD12_DBsites_27062018.bed")
head(read.table("H3K4me3_AD12_DBsites_27062018.bed"))
```
...
```{r}
library(rtracklayer)
save.image(file = "K4me3_12m_AD_csaw_pseudo_environment_27062018.Rda")
write.csv(all.results, file="H3K4me3_12m_AD_bcluster_DB_pseudo_all_results_27062018.csv")
```
